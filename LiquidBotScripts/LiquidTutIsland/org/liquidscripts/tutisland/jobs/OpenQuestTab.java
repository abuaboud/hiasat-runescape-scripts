 ...
 */
public class OpenQuestTab implements Job {
    @Override
    public void run() {
        if(Tab.QUEST.isOpen()){
            Tab.SETTINGS.open();
    ...
    public boolean isActive() {
        return Methods.getState().equals(State.OPEN_QUEST_TAB);  //To change body of implemented methods use File | Settings | File Templates.
    }
}
