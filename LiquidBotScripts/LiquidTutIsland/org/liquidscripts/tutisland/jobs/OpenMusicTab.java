 ...
 */
public class OpenMusicTab implements Job {
    @Override
    public void run() {
        if(Tab.MUSIC.isOpen()){
            Tab.SETTINGS.open();
    ...
    public boolean isActive() {
        return Methods.getState().equals(State.OPEN_MUSIC_TAB);  //To change body of implemented methods use File | Settings | File Templates.
    }
}
