 ...
 */
public class OpenEmoteHandler implements Job {
    @Override
    public void run() {
    ...
    public boolean isActive() {
        return Methods.getState().equals(State.OPEN_EMOTE_TAB);  //To change body of implemented methods use File | Settings | File Templates.
    }
}
